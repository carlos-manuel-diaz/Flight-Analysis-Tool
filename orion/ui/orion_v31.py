...
################################################################################
## Form generated from reading UI file 'orion_v3.1.ui'
##
...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        self.graphWidget.setLabel('bottom', 'X-axis', **label_style)
        self.graphWidget.setLabel('left', 'Y-axis', **label_style)
        ...
        self.displayButtons.addWidget(self.pushButton_2)

        self.pushButton = QPushButton(self.centralwidget)
        self.pushButton.setObjectName(u"pushButton")

        self.displayButtons.addWidget(self.pushButton)
    ...
    def retranslateUi(self, mainWindow):
        ...
        self.pushButton_2.setText(QCoreApplication.translate("mainWindow", u"Change Axis", None))
        self.pushButton.setText(QCoreApplication.translate("mainWindow", u"Toggle Attributes", None))
    # retranslateUi
